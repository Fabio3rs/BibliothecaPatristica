...
export const it: BaseTranslations = {
  ...
  searchIndexadorPoc: 'POC: questa ricerca usa PatrologiaIndexer e carica i riassunti solo per i risultati visibili.',
  searchIndexadorSample: 'Il campione locale contiene {count} volumi.',
  ...
  searchIndexUnavailable: "Indice PatrologiaIndexer non disponibile. Genera l'indice e ricarica.",
  searchIndexEmpty: 'Indice PatrologiaIndexer non disponibile o vuoto.',
