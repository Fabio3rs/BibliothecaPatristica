...
export const ptBR: Record<string, any> = {
  ...
  searchIndexadorPoc: 'POC: esta busca usa o PatrologiaIndexer e carrega o resumo somente para os resultados visíveis.',
  searchIndexadorSample: 'A amostra local contém {count} volumes.',
  ...
  searchIndexUnavailable: 'Índice PatrologiaIndexer não disponível. Gere o índice e recarregue.',
  searchIndexEmpty: 'Índice PatrologiaIndexer não disponível ou vazio.',
