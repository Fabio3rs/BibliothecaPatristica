...
export const en: Translations = {
  ...
  searchIndexadorPoc: 'POC: this search uses PatrologiaIndexer and loads summaries only for visible results.',
  searchIndexadorSample: 'The local sample contains {count} volumes.',
  ...
  searchIndexUnavailable: 'PatrologiaIndexer index not available. Build the index and reload.',
  searchIndexEmpty: 'PatrologiaIndexer index not available or empty.',
