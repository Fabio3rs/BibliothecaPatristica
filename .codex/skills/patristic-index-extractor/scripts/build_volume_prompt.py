...
def build_todo_lines(prescan: dict) -> str:
...
def main() -> None:
    ...
    ap.add_argument("--volume", required=True, help="Volume id, e.g. PG001 or PL099")
    ap.add_argument("--source-root", required=True, help="Text root, e.g. teste/PG001/text")
    ap.add_argument("--collection", required=True, help="Collection code, e.g. PG or PL")
